      ...
      <div className="info__wrapper">
        ...
        <div className="info__wrap block">
          <div className="block__img">
            ...
            <h3 className="block__img__title">S7 Airlines</h3>
          </div>
          <div className="block__distance">
            <p className="block__time">09:20</p>
            <p className="block__text">Москва</p>
            <p className="block__text block__text_data">19.05.2022</p>
          </div>
          ...
          <div className="block__distance">
            ...
            <p className="block__text">Ростов на Дону</p>
            <p className="block__text block__text_data">19.05.2022</p>
          </div>
